...
def background_predictor():
    ...
    while True:
        try:
            ...
            if not any(entry["period no"] == current_period for entry in history):
            ...
            if real_data:
                for entry in history:
                    p_no = entry["period no"]
                    # Agar result PENDING hai ya fir result field hi gayab hai
